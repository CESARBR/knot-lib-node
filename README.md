...
* `start` **String** the start date that you want your set of data (format=`YYYY/MM/DD HH:MM`)
* `finish` **String** the finish date that you want your set of data (format=`YYYY/MM/DD HH:MM`)
